...
public class Log {
  ...
  public Log setUnprocessedResponse(byte[] unprocessedResponse) {
    this.unprocessedResponse = unprocessedResponse;
    return this;
  }

  @Column(name = COLUMN_UNPROCESSEDRESPONSETIME_NAME)
  public Instant getUnprocessedResponseTime() {
    return unprocessedResponseTime;
  }

  public Log setUnprocessedResponseTime(Instant unprocessedResponseTime) {
    this.unprocessedResponseTime = unprocessedResponseTime;
    return this;
  }
