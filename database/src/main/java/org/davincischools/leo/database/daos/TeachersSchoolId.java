...
@Embeddable
public class TeachersSchoolId implements Serializable {

  public static final String COLUMN_TEACHERID_NAME = "teacher_id";
  public static final String COLUMN_SCHOOLID_NAME = "school_id";
  private static final long serialVersionUID = 1613455110235360557L;
  ...
  public TeachersSchoolId setTeacherId(Integer teacherId) {
  ...
  public TeachersSchoolId setSchoolId(Integer schoolId) {
  ...
  public boolean equals(Object o) {
    ...
    TeachersSchoolId entity = (TeachersSchoolId) o;
