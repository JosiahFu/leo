      ...
      <main>
        <section className="primary-section">
          ...
          <p>
            ...
            provides an easy way to incorporate differentiation into your class,
            while giving students the freedom to pursue projects that truly
            inspire them. Say goodbye to the monotony of traditional schooling
            and hello to a purposeful and engaging learning experience.
          </p>
          <button className="light" onClick={() => setInterestFormOpen(true)}>
            I'm interested! Tell me more!
          </button>
        ...
        <section>
          ...
          <p>
            ...
            find their own unique paths to success. By removing the rigidity of
            ...
            Project Leo helps to give school a purpose and prepares them for
        ...
        <section>
          ...
          <p>
            ...
            and enables them to develop a clear understanding of how their
            education can contribute to their professional goals.
          </p>
          {/* <IkigaiReel /> */}
          <div className="image-placeholder">[Image here]</div>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            any site issues? While you are exploring, please send all feedback
            and issues to Steven Eno -{' '}
