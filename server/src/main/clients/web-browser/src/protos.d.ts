...
export namespace greeter {
  ...
  class Greeter extends $protobuf.rpc.Service {
     ...
     */
    public sayHello(
      request: greeter.IHelloRequest,
      callback: greeter.Greeter.SayHelloCallback
    ): void;
     ...
     * @param callback Node-style callback called with the error, if any, and HelloReply
     */
    public sayHelloStreamReply(
      request: greeter.IHelloRequest,
      callback: greeter.Greeter.SayHelloStreamReplyCallback
    ): void;
  ...
  namespace Greeter {
     ...
     * @param [response] HelloReply
     */
    type SayHelloStreamReplyCallback = (
      error: Error | null,
      response?: greeter.HelloReply
    ) => void;
  }
  ...
  class HelloRequest implements IHelloRequest {
     ...
     */
    constructor(properties?: greeter.IHelloRequest);

    /** HelloRequest greeterName. */
    public greeterName?: string | null;

    /** HelloRequest _greeterName. */
    public _greeterName?: 'greeterName';
     ...
     */
    public static create(
      properties?: greeter.IHelloRequest
     ...
     * @returns HelloRequest
     */
    public static fromObject(object: {[k: string]: any}): greeter.HelloRequest;
  ...
  class HelloReply implements IHelloReply {
     ...
     * @param [properties] Properties to set
     */
    constructor(properties?: greeter.IHelloReply);

    /** HelloReply replyMessage. */
    public replyMessage?: string | null;

    /** HelloReply _replyMessage. */
    public _replyMessage?: 'replyMessage';
     ...
     */
    public static create(properties?: greeter.IHelloReply): greeter.HelloReply;
     ...
     * @returns HelloReply
     */
    public static fromObject(object: {[k: string]: any}): greeter.HelloReply;
