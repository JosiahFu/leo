...
/**
 * This class serves the static resources that were built by 'npm run build'
 * in one of the /clients/ subfolders, and placed into a /build/ subfolder
 * within the client.
 *
 * As part of the Maven build script, the /build/ subfolder's contents are
 * copied into the /target/classes/.../FileResourceController/www Maven
 * output directory. This makes them available as resources relative to
 * this class's file.
 */
@RestController
public class FileResourceController {
    ...
    private final static String UNKNOWN_MIME_TYPE = "unknown";
    private final static ImmutableMap<String, String> EXTENSIONS_TO_MIME_TYPES = ImmutableMap.<String, String>builder()
